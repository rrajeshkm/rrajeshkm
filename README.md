...
🚀 **Senior DevOps & Cloud Engineer** with **10+ years of experience** in designing, automating, and operating **secure, scalable cloud-native platforms**.
...
## 🔧 What I Work On
- Azure & Kubernetes (AKS) **production-grade deployments**
- CI/CD pipelines using **GitHub Actions & Azure DevOps**
- Infrastructure as Code with **Terraform & Terragrunt**
- Secure cloud architectures (**Private Endpoints, RBAC, MSI, DevSecOps**)

---

## 🤝 Collaboration & Interests
- Cloud-native & Kubernetes projects  
- DevOps / Platform engineering initiatives  
...
## 💬 Ask Me About
Azure • AKS • Kubernetes • Terraform • CI/CD • Cloud Networking & Security

⚡ *I enjoy simplifying complex cloud architectures using real-world analogies*  
🔁 *Strong believer in **automation first, scale later***
